...
1) *CREA AMBIENTE CON ANACONDA*
   ...
   - pip install [requirements] (se ci sono, in questo caso i requirements del progetto di AutoAlign + requests + transformers==4.28.1 + torch==1.13.1 + sentence_transformers + dotenv)
